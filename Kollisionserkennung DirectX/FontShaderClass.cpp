...
bool FontShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"../Kollisionserkennung DirectX/FontVertexShader.hlsl", L"../Kollisionserkennung DirectX/FontPixelShader.hlsl");
	if (!result)
	{
		return false;
	}
...
// Render will set the shader parameters and then draw the buffers using the font shader.Notice the is the same as TextureShaderClass except 
// that it takes in the new pixelColor parameter.
...
bool FontShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	result = D3DCompileFromFile(vsFilename, NULL, NULL, "FontVertexShader", "vs_5_0", D3DCOMPILE_DEBUG | D3DCOMPILE_SKIP_OPTIMIZATION, NULL,
	...
	result = D3DCompileFromFile(psFilename, NULL, NULL, "FontPixelShader", "ps_5_0", D3DCOMPILE_DEBUG | D3DCOMPILE_SKIP_OPTIMIZATION, NULL,
